...
def test_simple_harvest(gov, token, vault, dudesahn, strategist, whale, strategy, chain, strategist_ms, strategyProxy, gaugeIB):
    ...
    strategy.harvest({"from": gov})
    print("\nClaimable CRV after 1 day and harvest: ", strategyProxy.balanceOf(gaugeIB) / 1e18)
    # tx.call_trace(True)
